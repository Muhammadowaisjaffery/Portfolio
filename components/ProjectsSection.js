...
export default function ProjectsSection() {
  ...
  // Load only custom projects
  useEffect(() => {
    const customProjects = siteConfig.customProjects.map(project => ({
      ...project,
      stars: 0,
      forks: 0,
      language: project.tags[0] || 'Custom',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p style={{ color: 'var(--color-textSecondary)' }} className="text-xl max-w-2xl mx-auto">
            {loading ? 'Loading projects...' : `${projects.length} projects showcasing my work`}
          </p>
        </motion.div>
